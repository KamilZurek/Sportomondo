...
namespace Sportomondo.Api.Migrations
{
    ...
    [Migration("20231113163216_AchievmentsUsersManyToManyRelationship")]
    partial class AchievmentsUsersManyToManyRelationship
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sportomondo.Api.Models.Achievement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("CountingRequiredValue")
                        .HasColumnType("decimal(18,2)");

                    b.Property<int>("CountingType")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AchievementUser", b =>
                {
                    b.HasOne("Sportomondo.Api.Models.Achievement", null)
                        .WithMany()
                        .HasForeignKey("AchievementsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Sportomondo.Api.Models.User", null)
                        .WithMany()
